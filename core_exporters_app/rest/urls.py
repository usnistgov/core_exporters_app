...
urlpatterns = [
    re_path(r'^exporter/export/$', exporters_views.ExportToZip.as_view(),
            name='core_exporters_app_rest_exporter_export'),

    re_path(r'^exporter/xsl/$', xsl_views.ExporterXslList.as_view(),
            name='core_exporters_app_rest_exporter_xsl'),

    re_path(r'^exporter/xsl/(?P<pk>\w+)/$', xsl_views.ExporterXslDetail.as_view(),
            name='core_exporters_app_rest_exporter_xsl_detail'),

    re_path(r'^exporter/$', exporters_views.ExporterList.as_view(),
            name='core_exporters_app_rest_exporter'),

    re_path(r'^exporter/(?P<pk>\w+)/$', exporters_views.ExporterDetail.as_view(),
            name='core_exporters_app_rest_exporter_detail'),

    re_path(r'^exporter/export/download/(?P<pk>\w+)/$', exporters_views.ExporterDownload.as_view(),
